...
public class MainActivity extends ListActivity 
{
	...
	private static final Object tag1 = null;
 ...
 // add new search to the save file, then refresh all Buttons
    @SuppressLint("NewApi") private void addTaggedSearch(String query, String tag)
    {
 ...
 // itemLongClickListener displays a dialog allowing the user to delete 
    ...
    OnItemLongClickListener itemLongClickListener = 
       new OnItemLongClickListener()
       {
             ...
             int position, long id)
          {
             ...
             builder.setItems(R.dialog_items, 
    ...
    @SuppressLint("NewApi") private void deleteSearch(final String tag)
    {
       // create a new AlertDialog
